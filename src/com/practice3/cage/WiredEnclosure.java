...
public class WiredEnclosure extends Cage {

	/*
	 * Limit of each Animal(i.e Lion, Zebra) in WiredEnclosure Cage. List contains
	 * Animal's Name and it's value in Integer
	 */
	private Map<String, Integer> limitListOfSpecificAnimalType;
	private List<Animal> listOfAnimals;

	public WiredEnclosure(Map<String, Integer> limitListOfSpecificAnimalType, int capacity, String type,
